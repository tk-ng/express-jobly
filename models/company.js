...
class Company {
	...
	static async findAll(filter = {}) {
		...
		if (minEmployees !== undefined) {
			...
			whereStatement.push(`num_employees >= $${queryValues.length}`);
		}
		...
		if (name !== undefined) {
			...
			whereStatement.push(`name ILIKE $${queryValues.length}`);
		}
		...
		const companiesRes = await db.query(queryString, queryValues);
